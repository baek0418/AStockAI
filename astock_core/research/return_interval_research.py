...
from astock_core.research.prediction_model import create_rolling_windows, split_by_window
...
def main():
    ...
    parser.add_argument("--project-directory", type=Path, default=Path(__file__).parents[2])
