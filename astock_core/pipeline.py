...
from astock_core.reporting.daily_report import run_daily_report
from astock_core.reporting.daily_signal import run_daily_signal
from astock_core.reporting.email_report import send_daily_report
...
from astock_core.research.research_data import run_research_data
from astock_core.research.research_summary import run_research_summary
from astock_core.data.update_data import run_update_data
from astock_core.data.watchlist_snapshot import run_watchlist_snapshot
...
def print_pipeline_summary(pipeline_result):
    ...
    log_file = Path(__file__).parents[1] / "logs" / f"astockai_{datetime.now().strftime('%Y-%m-%d')}.log"
